...
// int32 key = 1;
inline void GetVarifyReq::clear_key() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.key_ = 0;
}
inline ::int32_t GetVarifyReq::key() const {
  // @@protoc_insertion_point(field_get:message.GetVarifyReq.key)
  return _internal_key();
}
inline void GetVarifyReq::set_key(::int32_t value) {
  _internal_set_key(value);
  // @@protoc_insertion_point(field_set:message.GetVarifyReq.key)
}
inline ::int32_t GetVarifyReq::_internal_key() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.key_;
}
inline void GetVarifyReq::_internal_set_key(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.key_ = value;
}
